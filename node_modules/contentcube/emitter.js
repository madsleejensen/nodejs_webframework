/**
 * Emitter that will execute listeners in sequence and allow the publisher to be notified 
 * when all listeners has been executed. 
 * this is ideal for implementing hooks.
 */
exports.createNew = function () {
	...
	instance.emit = function(event, args, callback) {
		...
		var queue = listeners[event].splice();	
